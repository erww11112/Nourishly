...
function ChooseLanguage({ onComplete }) {
  ...
  const labelKeys = { en:"profile.languageEnglish", pt:"profile.languagePortuguese", es:"profile.languageSpanish", zh:"profile.languageChinese", fr:"profile.languageFrench", de:"profile.languageGerman", it:"profile.languageItalian", ru:"profile.languageRussian" };
          ...
          <div>
            ...
            <div style={{ background:C.card, borderRadius:R.xl, border:`1px solid ${C.border}`, boxShadow:SHADOW.card, padding:"22px", marginBottom:20 }}>
              ...
              <div style={{ display:"flex", background:C.bg, borderRadius:R.md, padding:4 }}>
                {[["en",t("profile.languageEnglish")],["pt",t("profile.languagePortuguese")],["es",t("profile.languageSpanish")],["zh",t("profile.languageChinese")],["fr",t("profile.languageFrench")],["de",t("profile.languageGerman")],["it",t("profile.languageItalian")],["ru",t("profile.languageRussian")]].map(([code,label])=>(

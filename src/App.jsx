...
function ChooseLanguage({ onComplete }) {
  ...
  const labelKeys = { en:"profile.languageEnglish", pt:"profile.languagePortuguese", es:"profile.languageSpanish", zh:"profile.languageChinese" };
          ...
          <div>
            ...
            <div style={{ background:C.card, borderRadius:R.xl, border:`1px solid ${C.border}`, boxShadow:SHADOW.card, padding:"22px", marginBottom:20 }}>
              ...
              <div style={{ display:"flex", background:C.bg, borderRadius:R.md, padding:4 }}>
                {[["en",t("profile.languageEnglish")],["pt",t("profile.languagePortuguese")],["es",t("profile.languageSpanish")],["zh",t("profile.languageChinese")]].map(([code,label])=>(

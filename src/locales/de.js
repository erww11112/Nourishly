...
export const de = {
  ...
  onboarding: {
    ...
    allergyConsent: "Ich stimme zu, dass Nourishly und sein KI-Anbieter diese gesundheitsbezogenen Informationen verarbeiten, um meine Essenspläne zu personalisieren.",
